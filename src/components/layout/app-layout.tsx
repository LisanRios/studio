...
const Logo = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 text-primary" aria-label="Logo del Archivo de Álbumes">
  ...
  return (
    <nav className="sticky top-0 z-50 flex h-16 items-center justify-between border-b bg-background/90 backdrop-blur-sm px-4 sm:px-6 md:px-8">
      ...
      <Link href="/" className="flex items-center gap-2">
        <Logo />
        <span className="text-xl font-semibold text-primary hidden sm:inline-block">Archivo de Álbumes</span>
      </Link>
          ...
          <div className="flex flex-col h-full">
            <div className="p-4 border-b border-border">
              <Link href="/" className="flex items-center gap-2" onClick={() => setMobileMenuOpen(false)}>
                <Logo />
                <span className="text-xl font-semibold text-primary">Archivo de Álbumes</span>
              </Link>
            </div>
